...
class _AdminOrderDetailsScreenState extends State<AdminOrderDetailsScreen> {
  ...
  Widget _buildPaymentDetails(ThemeData theme) {
    ...
    final displayStatus = isCancelled ? 'Cancelled Payment' : paymentStatus;
    final statusColor =
        isCancelled
            ? Colors.red
            : (paymentStatus == 'Paid' ? Colors.green : Colors.orange);

    final showReceivePaymentButton =
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (confirmed == true) {
                        ...
                        // ====================================
                        // TODO: Not Confromed Feature might need to change later
                        // ====================================
